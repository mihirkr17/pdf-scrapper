const postTemplate = [
   ...
   },
   {
      ...
      eventTag: "#eventName Pronósticos",
      contents: function (eventName,
         leads,
         eventAddress,
         playerOne,
   ...
   },
   {
      ...
      eventTag: "#eventName Tipps & Prognosen",
      contents: function (eventName,
         leads,
         eventAddress,
         playerOne,
   ...
   },
   {
      ...
      eventTag: "#eventName Прогнозы ATP / WTA на теннис",
      contents: function (eventName,
         leads,
         eventAddress,
         playerOne,
